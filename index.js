...
const rejectionReasonRoutes = require("./routes/orderRejectionRoute");
const promotionRoutes = require("./routes/promotionRoutes");
const reviewsRoutes = require("./routes/reviewsRoutes");
const anaylaticsRoutes = require("./routes/anaylaticsRoutes");
...
app.use("/api/rejection/", rejectionReasonRoutes);
app.use("/api/promotion/", promotionRoutes);
app.use("/api/reviewsRoutes/", reviewsRoutes);
app.use("/api/anaylatics/", anaylaticsRoutes);
